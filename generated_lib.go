...
// DO NOT EDIT; AUTOGENERATED ON Sat Jul 26 10:08:57 2025
const (
...
func (c *SpeechAndVerbosityManager) AvailableServers(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "AvailableServers", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) AvailableSynthesizers(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "AvailableSynthesizers", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) AvailableVoices(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "AvailableVoices", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) CurrentServer(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "CurrentServer", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) CurrentSynthesizer(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "CurrentSynthesizer", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) CurrentVoice(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "CurrentVoice", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
func (c *SpeechAndVerbosityManager) Pitch(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "Pitch", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
...
// Returns the current speech rate.
func (c *SpeechAndVerbosityManager) Rate() (float64, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
...
func (c *SpeechAndVerbosityManager) Volume(notifyUser bool) (string, error) {
	obj := c.conn.Object("org.gnome.Orca.Service", "/org/gnome/Orca/Service/SpeechAndVerbosityManager")
	var result string
	err := obj.Call("org.gnome.Orca.Module.ExecuteRuntimeGetter", 0, "Volume", notifyUser).Store(&result)
	if err != nil {
		return "", err
	}
	return result, nil
